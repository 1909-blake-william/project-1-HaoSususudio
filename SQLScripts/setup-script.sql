...
BEGIN
  ...
  request_new_reimbursement(585.00, 'A candle light dinner', 3, 3, gen_id);
  request_new_reimbursement(52600.00, 'A lot of honey', 5, 3, gen_id);
  request_new_reimbursement(8545650.00, 'A lot of piglets', 5, 3, gen_id);
  request_new_reimbursement(37650.00, 'A lot of soybeans', 5, 3, gen_id);
  request_new_reimbursement(2.10, 'bowbowbow', 4, 3, gen_id);
  request_new_reimbursement(1.10, 'bark bark bark', 4, 3, gen_id);
  request_new_reimbursement(37.50, 'woof bow wooooof', 4, 3, gen_id);
  ...
  UPDATE ers_reimbursement SET reimb_submitted = TO_TIMESTAMP ('11-Oct-19 18:52:11.123000', 'DD-Mon-RR HH24:MI:SS.FF') WHERE reimb_id = 11;
  UPDATE ers_reimbursement SET reimb_submitted = TO_TIMESTAMP ('19-Oct-19 02:23:58.123000', 'DD-Mon-RR HH24:MI:SS.FF') WHERE reimb_id = 12;
  UPDATE ers_reimbursement SET reimb_submitted = TO_TIMESTAMP ('23-Oct-19 11:33:56.123000', 'DD-Mon-RR HH24:MI:SS.FF') WHERE reimb_id = 13;
